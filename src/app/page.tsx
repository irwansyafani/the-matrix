...
export default function Home() {
  /*
- [x] Component Input Matrix Dimension (4x4)
- [x] Component Generated Matrix Dimension (table)
- [x] Able to input the number for each box
- [x] When click submit
  - [x] the integers will be sorted from lowest to highest
  - [x] the rows will be sorted from lowest to highest

- [x] Input target number
- [] The output is the match box will have shining color
 */
